...
const Countries = () => {
  ...
  return (
    ...
    >
      <SEOMeta
        title="Global Territories Analytics"
      ...
      {/* Header section */}
      <Box sx={{ mb: 4 }}>
        <Typography variant="h4" fontWeight="900" color="primary" sx={{ letterSpacing: '-0.02em', mb: 1 }}>
          Global Territories Intelligence
        </Typography>
        <Typography variant="body1" color="text.secondary">
          Live telemetry, predictive analysis, and human capital metrics across monitored regions.
        </Typography>
      </Box>
